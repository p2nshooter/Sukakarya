...
VALUES
  ...
  ('svc_demo_usaha', 'vil_demo', 'surat-keterangan-usaha',
   ...
   '[{"name":"nama_usaha","label":"Nama Usaha","type":"text","required":true},{"name":"alamat_usaha","label":"Alamat Usaha","type":"text","required":true}]',
   3, 1, 0, 1, 'published', 20),
